...
'var inact=(r.flag==="reclaim"||r.flag==="watch"||r.flag==="neverused");',
'out+="<tr class=\\""+r.flag+"\\"><td class=\\"email"+(inact?" inactive":"")+"\\">"+(inact?"<span class=\\"dot\\">\\u25CF</span>":"")+esc(r.email)+"</td><td>"+(r.flag==="unlicensed"?"\\u2014":(r.assigned||"\\u2014"))+"</td><td>"+(r.last||"\\u2014")+"</td><td>"+(r.flag==="unlicensed"?"\\u2014":(r.idle===""?"<span class=\\"pill reclaim\\">\\u221E</span>":"<span class=\\"pill "+r.flag+"\\">"+r.idle+"d</span>"))+"</td></tr>";});}});',
'tb.innerHTML=out;',
